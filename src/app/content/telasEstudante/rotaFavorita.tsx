...
import "../../../../global.css";
import { faMagnifyingGlass, faArrowLeft, faCalendar, faClock, faLocationDot, faUser, faStar } from '@fortawesome/free-solid-svg-icons';
...
export default function telaRotaFavorita() {
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        ...
                        <View style={{flexDirection: 'row', alignItems:'center', marginTop: 25, gap:6, marginLeft: 10, marginRight: 10}}>
                            ...
                            <Button rounded={3000} style={{ height:30, width: 114, backgroundColor: '#FFD6D7'}} onPress={() => {
                            ...
                            <Button rounded={3000}  border={ '2px solid #ccc'} style={{ height:30, width:105, backgroundColor: '#FF9292'}} onPress={() => {
