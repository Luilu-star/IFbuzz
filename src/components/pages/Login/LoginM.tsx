    ...
    return (
            <View style={styles.container}>
                ...
                <View style={{padding: 30}}>
                    ...
                    <Text style={{marginTop: 60, marginBottom: 10, fontWeight: 'bold', fontSize: 20}}>Email</Text>
                    <Input border='none' bg={'#F5F5F5'} rounded={18} height={56} placeholder='Email'></Input>
